...
// We define them as 'any' to bypass strict type checking for these R3F elements
declare global {
  namespace JSX {
...
// Also augment React's JSX namespace for compatibility with different TS configurations
